        ...
        <section className="py-16 xl:py-24">
            <GridContainer>
                <div className="w-full max-w-3xl mb-16">
                    ...
                    <p className="text-lg/relaxed xl:text-xl/6 text-gray-600">We’ve done all the heavy lifting so you don’t have to — get all the
                ...
                <div className="flex flex-col xl:flex-row gap-12 xl:gap-0 items-center justify-between ">
                    ...
                    <div className="w-full max-w-xl grid grid-cols-1 xl:grid-cols-2

...
export function Footer(){
    return (
        <footer className="py-12 xl:pt-16">
            <GridContainer >
                <div className="grid xl:flex grid-cols-2 gap-8 xl:gap-0 items-start 
                justify-between pb-12 xl:pb-16">
                    <ItemNav 
                       title="Product"
                ...
                justify-between gap-6 xl:gap-0 border-t border-gray-200 pt-8">
                    <Image 
                    src="/Logo.svg"
                    width={142}
                    height={82}

...
export function ItemFeature ({ icon, title, text, isBtn = false} : ItemFeatureProps){
    return (
        <div className="text-center w-full max-w-96">
            <div className="w-12 h-12 bg-brand-100 rounded-full mx-auto 
            border-8 border-brand-50 mb-5 flex items-center justify-center">
            ...
            font-semibold text-brand-700 gap-2 hover:opacity-50 transition-opacity">
                Learn more

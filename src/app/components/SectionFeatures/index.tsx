        ...
        <section className="py-16 xl:py-24">
            <GridContainer>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-x-8 gap-y-12 xl:gap-y-16">
                    ...
                    text="Whether you have a team of 2 or 200, our 
                    ...
                    text="An all-in-one customer service platform that 
                    helps you balance everything your customers need to be happy."
                    />
                    ...
                    text="Solve a problem or close a sale in real-time with chat. If no one is available, 
                    ...
                    text="Explore 100+ integrations that make your day-to-day workflow more 
                    ...
                    text="We are an extension of your customer service team, and all of our
